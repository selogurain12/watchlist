...
const project_users_entity_1 = require("../project-user/project-users.entity");
...
__decorate([
    (0, typeorm_1.OneToMany)(() => project_users_entity_1.ProjectUser, projectUser => projectUser.project),
