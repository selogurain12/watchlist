...
let ProjectUserController = class ProjectUserController {
    ...
    async assignUserToProject(body) {
        try {
            return await this.projectUserService.assignUserToProject(body.startDate, body.endDate, body.userId, body.projectId);
        }
        catch (error) {
            throw error;
        }
...
], ProjectUserController.prototype, "assignUserToProject", null);
exports.ProjectUserController = ProjectUserController = __decorate([
    (0, common_1.Controller)('project-users'),
    __metadata("design:paramtypes", [project_users_service_1.ProjectUserService])
