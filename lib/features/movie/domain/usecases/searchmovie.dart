...
class SearchMovieUseCase implements UseCase<DataState<ApiMovieResponseEntity>, ApiMovieRequestEntity> {
  final ApiMovieRepository repository;
  const SearchMovieUseCase(this.repository);
  
  @override
  Future<DataState<ApiMovieResponseEntity>> call({ApiMovieRequestEntity? params}) {
