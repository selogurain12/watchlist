...
class _UserApiService implements UserApiService {
  ...
  Future<HttpResponse<LoginUserResponseModel>> login({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<LoginUserResponseModel>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  Future<HttpResponse<RegisterUserResponseModel>> register({
    ...
    _data.addAll(body?.toJson() ?? <String, dynamic>{});
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<RegisterUserResponseModel>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
